    ...
    <View style={styles.container}>
      <ImageBackground source={require('../../assets/black-hole.jpg')} style={styles.background}>
        <View style={styles.container2}>
          ...
          <TextInput style={styles.inputField}  placeholder="Confirm password" secureTextEntry></TextInput>
          <Pressable style={styles.buttonLogin} onPress={() => navigation.navigate('Topics')}>Select topics</Pressable>
          <Pressable style={styles.buttonRegister} onPress={() => navigation.navigate('Login')}>Already have an account? Sign in</Pressable>
        </View>
      </ImageBackground>
    </View>
